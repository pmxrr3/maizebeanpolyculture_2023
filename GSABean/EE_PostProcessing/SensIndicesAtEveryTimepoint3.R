...
field_Rep_1 <- 'C:/Users/pmxrr3/OneDrive - The University of Nottingham/FSPM/Climbing bean data for experiments/GSA/Output/field_Rep_1.txt'
field_Rep_2 <- 'C:/Users/pmxrr3/OneDrive - The University of Nottingham/FSPM/Climbing bean data for experiments/GSA/Output/field_Rep_2.txt'
field_Rep_3 <- 'C:/Users/pmxrr3/OneDrive - The University of Nottingham/FSPM/Climbing bean data for experiments/GSA/Output/field_Rep_3.txt'
parameterbounds <- 'C:/Users/pmxrr3/OneDrive - The University of Nottingham/FSPM/Climbing bean data for experiments/GSA/Input/ParametersBean_EE.txt'
simulationpoints <- 'C:/Users/pmxrr3/OneDrive - The University of Nottingham/FSPM/Climbing bean data for experiments/GSA/Input/Bean_EE_Trajectories.txt'
...
colourarray <- colorRampPalette(brewer.pal(12, "Paired"))(length(uniqueindices))
#
par(xpd=TRUE) #square
if(1 %in% indicesfieldRFR){
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.3), c(fieldRFRSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; canopy R/FR-ratio"), type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
} else {
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.3), c(fieldRFRSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; canopy R/FR-ratio"), type="l", col="gray")
}
for(j in 2:(nrOfParameters)){
  if(j %in% indicesfieldRFR){
    lines(1:nrOfSimDays,c(fieldRFRSensMatrix[1:nrOfSimDays,j]), col=colourarray[which(uniqueindices %in% j)], type="l", lwd="2") 
  } else {
...
if(1 %in% indicesassCO2){
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.3), c(assCOtwoSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; assimilated CO2"), type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
} else {
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.3), c(assCOtwoSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; assimilated CO2"), type="l", col="gray")
}
for(j in 2:(nrOfParameters)){
...
par(xpd=TRUE) #square
if(1 %in% indicesfAbs){
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.3), c(fAbsSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; fraction rad. absorbed"), type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
} else {
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.3), c(fAbsSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; fraction rad. absorbed"), type="l", col="gray")
}
for(j in 2:(nrOfParameters)){
  if(j %in% indicesfAbs){
...
if(1 %in% indicesBiom){
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.3), c(BiomSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; aboveground biomass"), type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
} else {
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.3), c(BiomSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; aboveground biomass"), type="l", col="gray")
}
for(j in 2:(nrOfParameters)){
  if(j %in% indicesBiom){
...
if(1 %in% indicesYield){
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(YieldSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; yield"), type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
} else {
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.4), c(YieldSensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; yield"), type="l", col="gray")
}
for(j in 2:(nrOfParameters)){
...
par(xpd=TRUE) #square
if(1 %in% indicesLAI){
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.3), c(LAISensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; LAI"), type="l", col=colourarray[which(uniqueindices %in% 1)], lwd="2") 
} else {
  plot(xlim = c(1,nrOfSimDays), ylim=c(0,0.3), c(LAISensMatrix[1:nrOfSimDays,1]), xlab="Simulation day", ylab=expression(S[chi] ~ "; LAI"), type="l", col="gray")
}
for(j in 2:(nrOfParameters)){
  if(j %in% indicesLAI){
